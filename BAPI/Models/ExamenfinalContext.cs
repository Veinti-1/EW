...
public partial class ExamenfinalContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
...

        {
            ...
            var connectionString = "Server=127.0.0.1;Port=3307;Database=examenfinal;Uid=root;Pwd=root;";//configuration.GetConnectionString("Defaultpd");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Bicicleta>(entity =>
        {
            ...
            entity.Property(e => e.TamañoPulgadas).HasColumnName("tamaño_pulgadas");
